...
SECRET_KEY = 'django-insecure-4np%l758tnz7)1$6x9_*8$-au8l6b60!-h&c#(u8%an-o8_qd+'
...
INSTALLED_APPS = [
    ...
    'card_auth',
    'corsheaders',  # Required for extension to call API
]
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'data' / 'db.sqlite3', # Store in subfolder for easier mounting
    }
}
